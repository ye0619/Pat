...
<p align="center">
  <em>把手机变成温柔可爱的手机娘 — 会抱怨、会道谢，也会喊疼。</em>
</p>
...
**Pat** 是一款基于传感器的事件驱动型 Android 轻量级应用。它持续感知你的手机状态 — 屏幕使用、电池电量、摇晃、跌落、点击 — 并在合适的时机用语音和通知给你拟人化的反馈。
...
你可以设置每次打开屏幕时播放《关羽之歌》，感受手机娘的“释怀”。也可以每点击三次手机便受到手机娘的质问：“为什么要演奏春日影！！！”
...
- **自定义事件系统** — 支持摇晃、敲击、跌落、亮屏/息屏、充电/断电、电量变化、深夜使用、点击、长按等原子事件类型
...
软件目前仅是一个demo，由于个人精力有限，项目未做完整的测试，有可能存在诸多问题。项目很多功能因本人能力不足暂时取消。如果你有什么好的想法也欢迎随时联系
